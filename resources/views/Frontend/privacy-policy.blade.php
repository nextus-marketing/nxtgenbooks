...
@section('title') Privacy Policy | NxtGen Books @endsection
@section('content')
<style>
    h4 {
    font-size: 20px;
...
<section class="breadcrumb__area pt-165 pb-150 p-relative z-index-1 fix" data-bg-color="#16243E">
    ...
    <div class="container pt-70 pb-50">
        <div>
            ...
            <p><strong>Company</strong> – Refers to NxtGen Books.</p>
            <p><strong>Cookies</strong> – Small files stored on Your device containing browsing details.</p>
            <p><strong>Country</strong> – New Jersey, United States.</p>
            <p><strong>Device</strong> – Any device that can access the Service (computer, mobile, tablet).</p>
            <p><strong>Personal Data</strong> – Information relating to an identified or identifiable individual.</p>
            ...
            <p><strong>Website</strong> – NxtGen Books, accessible at https://nxtgenbooks.com/</p>
            ...
            <p>Cookies used:</p>
            <ul>
                <li>Necessary Cookies – Enable essential functionality.</li>
            ...
            <p>Email: <a href="mailto:info@nxtgenbooks.com"> info@nxtgenbooks.com</a></p>
        </div>
    </div>
</section>
