...
<script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
   ...
   <body>
               ...
               <div class="row align-items-center">
                  <div class="col-xl-4 col-6">
                     <div class="tp-header-logo-2 p-relative">
                        <a href="/">
                          <img src="/frontend/my-img/logo.png" alt="logo" style="width:300px; height:70px;" >
                        </a>
                     </div>
                  </div>
      ...
      @yield('content')
         <!-- footer area start -->
         <footer class="tp-footer-area-2 pt-60 p-relative z-index-1" data-bg-color="#ffffff;">
                  ...
                  <div class="row">
                     <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                        <div class="tp-footer-widget tp-footer-2-col-1 mb-50">
                           ...
                           <a href="/"> <img src="/frontend/my-img/logo.png" alt="logo" style="width:300px; height:70px;" ></a>
                           </div>
                           <div class="tp-footer-widget-content">
                              <p style="color:#16243e;">NxtGen Books is a trusted accounting and financial services firm providing expert bookkeeping, tax, and payroll solutions. We help businesses and individuals stay organized, compliant, and audit-ready.</p>
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-3 col-lg-2 col-md-6 col-sm-6">
                        <div class="tp-footer-widget tp-footer-2-col-2 mb-50">
                           <h3 class="tp-footer-widget-title" style="color:#00A3C3;">Quick links</h3>
                           <div class="tp-footer-widget-content">
                              <ul>
                                 <li><a href="/" style="color:#16243e;">Home</a></li>
                                 <li><a href="/#about" style="color:#16243e;">About Us</a></li>
                                 <li><a href="/#contact" style="color:#16243e;">Contact Us</a></li>
                              </ul>
                           </div>
                        </div> 
                     </div>
                     <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="tp-footer-widget tp-footer-2-col-3">
                            <h3 class="tp-footer-widget-title" style="color:#00A3C3;">Get In Touch</h3>
                            <div class="tp-footer-widget-content">
                                <div class="tp-footer-widget-item">
                                    <span style="color:#16243e;"><i class="fa-regular fa-envelope"></i> info@nxtgenbooks.com</span>
                                </div>
                                <div class="tp-footer-widget-item">
                                    <span style="color:#16243e;"><i class="fa-solid fa-phone"></i> (+0) 123 456 789</span>
                                </div>
                                <div class="tp-footer-widget-item">
                                    <span style="color:#16243e;"><i class="fa-solid fa-location-dot"></i> 255 Sheet, City Name Home Land, NY</span>
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                     <div class="col-md-12 col-lg-6">
                        <div class="tp-footer-copyright-inner">
                           <p style="color:#16243e;">© NxtGen Books 2025 | All Rights Reserved</p>
                        </div>
                     </div>
                     <div class="col-md-12 col-lg-6">
                        <div class="tp-footer-copyright-inner text-lg-end">
                           <a href="/privacy-policy" style="color:#16243e;">Privacy Policy</a>
                           <a href="/terms-and-conditions" style="color:#16243e;">Terms And Condtions</a>
                        </div>
                     </div>
                  </div>
               </div>
